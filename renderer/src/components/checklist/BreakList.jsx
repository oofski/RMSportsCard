...
function badgeFor(brk) {
  ...
  switch (brk.status) {
    case 'packed':
      return { cls: 'green', text: breakStatusLabel('packed').toUpperCase() }
    case 'shipped':
      return { cls: 'green', text: breakStatusLabel('shipped').toUpperCase() }
    case 'picking':
      return { cls: 'amber', text: breakStatusLabel('picking').toUpperCase() }
    default:
      return { cls: '', text: breakStatusLabel('pending').toUpperCase() }
  }
}
